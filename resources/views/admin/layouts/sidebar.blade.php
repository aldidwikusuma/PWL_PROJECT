...
<ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
    ...
    <!-- Sidebar - Brand -->
    <a class="sidebar-brand d-flex align-items-center justify-content-center" href="{{ route(config("data.route.admin.index")) }}">
    ...
    <li class="nav-item active">
        <a class="nav-link" href="{{ route(config("data.route.admin.index")) }}">
