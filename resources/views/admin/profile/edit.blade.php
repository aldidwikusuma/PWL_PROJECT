                    ...
                    <div class="card-body">
                        <div class="row row-2">
                            ...
                            <tr>
                                ...
                                <td><input type="{{Auth::user()->email}}" readonly value="{{Auth::user()->email}}" name="email" ></td>
                            </tr>
