...
@section('container')
    <h2 class="mb-3">Create new Schedule Film</h2>
    ...
    <div class="col-md-8 mb-5 p-0">
        <form action="{{ route(config("data.route.admin.schedules.store")) }}" method="post">
			@csrf
			<div class="mb-3">
				<label for="date" class="form-label">Date & Time</label>
				<div class="input-group">
					<label for="date" class="input-group-text">Date</label>
					<input type="date" name="date" class="form-control @error('date') is-invalid @enderror" id="date" value="{{ old("date", $datenow) }}" required autofocus>
